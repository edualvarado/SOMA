"""
Script: manual_marker_annotator.py
Goal: Takes the previous debug image debug/skin_charuco-suit.jpg and annotates to create the json markers-skin-manual.json

Interactive tool to manually annotate markers in an image.
"""
...
def mouse_callback(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        if len(current_marker_corners) < 4:
            ...
            if len(current_marker_corners) == 4:
                print("4 corners selected. Press 'n' to enter ID, or 'c' to clear these 4 points.")
        else:
...
def main():
    ...
    input_image = "S3/debug/skin_charuco-suit.jpg"
    output_json = "S3/uv_detections_charuco-suit/markers-skin-manual.json"
