...
# CANONICAL_MARKERS_JSON_PATH = "S:/work/03-MUSK/04-Blender/data/registration/canonical_model/canonical_data.json"
CANONICAL_MARKERS_JSON_PATH = "S:/work/03-MUSK/03-Registration/registration/S2/canonical_model/S2_canonical_data.json"
...
MARKER_CLOUD_OFFSET = (-0.001799, -0.070466, -0.007204)

# NEW SKELETON (INSIDE HUMANS ADAPTED TO STUDIO)
ARMATURE_OBJECT_NAME = f"root-NewSkeleton-001"
ARMATURE_OBJECT_NAME = f"root_001_S2"

# MARKER LBS WEIGHTS WITH RESPECT TO NEW SKELETON (INSIDE HUMANS ADAPTED TO STUDIO)
# MARKER_LBS_WEIGHTS_JSON_PATH = "S:/work/03-MUSK/04-Blender/data/weights/canonical_model/lbs_markers/markers_lbs_weights_exported_new_skeleton.json"
MARKER_LBS_WEIGHTS_JSON_PATH = "S:/work/03-MUSK/03-Registration/registration/S2/canonical_model/S2_marker_lbs_weights_exported.json" 

# NAMING
MARKER_CLOUD_OBJ_NAME = f"LBS_Canonical_Markers_{shot_number}"
COLLECTION_NAME = f"LBS_Canonical_Markers_{shot_number}"

# PARENT_COLLECTION_NAME = "Shot_001_V2"
