...
# MODEL
# shot = "FBX-NewSkeleton"  # Change this to your shot name
...
CANONICAL_MARKERS_JSON_PATH = "S:/work/03-MUSK/03-Registration/registration/S5/canonical_model/S5_canonical_data.json"
...
MARKER_CLOUD_OFFSET = (0, 0, 0)

# NEW SKELETON (INSIDE HUMANS ADAPTED TO STUDIO)
# ARMATURE_OBJECT_NAME = f"root-NewSkeleton"
ARMATURE_OBJECT_NAME = f"root_001_S5_APose"
...
COLLECTION_NAME = f"LBS_Canonical_Markers_S5_{shot}_APose"

# PARENT_COLLECTION_NAME = "FBX-NewSkeleton"
