...
import json
import numpy as np
from mathutils import Vector  # Import Blender's Vector type

# --- USER: SET THESE ---
SKINNED_OBJECT_NAME = "skin_001"  # Name of the skinned mesh
ARMATURE_NAME = "root_001"        # Name of the armature
WEIGHTS_JSON_FILE = "S:/work/03-MUSK/04-Blender/data/weights/canonical_model/lbs_skin/skin_lbs_weights_exported_tpose.json"
# ------------------------
